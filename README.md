...
| [`spark`](skills/spark/) | Find the single smartest, most innovative addition to your current PR/branch or project, then implement it | "/spark", "what's the most impactful thing you could add to this PR?", "what single feature would make this better?" |
